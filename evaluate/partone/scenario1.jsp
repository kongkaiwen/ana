...
<html>
	...
	<body>
		...
		<div id="wrapper">
			...
			<input class="ana-button" id="next-button" type="button" value="Next" href="scenario2.html" />
		    ...
		    <p align="center" class="scenario"><b>Scenario:</b> Your name is Irene.  You have a daughter named Jana and you just came back from spending the day with her.</p>
